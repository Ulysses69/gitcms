...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo URL_PUBLIC; ?>inc/img/icon.ico">
  ...
  <script src="<?php echo URL_PUBLIC.ADMIN_DIR; ?>/javascripts/prototype.js" type="text/javascript"></script>
  <script src="<?php echo URL_PUBLIC.ADMIN_DIR; ?>/javascripts/effects.js" type="text/javascript"></script>
</head>
<body id="login">
  <div id="dialog">
