...
<div id="site-map-def" class="index-def">
  <div class="layout"><?php echo __('Layout'); ?> (<a href="#" id="toggle_reorder" onclick="$$('.handle').each(function(e) { e.style.display = e.style.display != 'inline' ? 'inline': 'none'; }); return false;"><?php echo __('reorder'); ?></a>)</div><div class="modify"><?php echo __('Action'); ?></div>
</div>
