...
* The settings() function in the HelpController.php file demonstrates the
...
* Did you know you can have the controller make a visible tab (or not)? Change
    Plugin::addController('help_docs', 'Help', 'administrator', false);
  to
    Plugin::addController('help_docs', 'Help', 'administrator', true);
