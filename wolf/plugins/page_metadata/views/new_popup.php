<div class="popup" id="<?php echo $css_id_prefix; ?>new-popup" style="display: none;">
  ...
  <div id="<?php echo $css_id_prefix; ?>busy" class="busy" style="display: none;"><img alt="Spinner" src="<?php echo URI_PUBLIC;?>wolf/admin/images/spinner.gif" /></div>
  ...
  <form action="#" method="post" onsubmit="page_metadata_add('<?php echo $plugin_url?>template', '<?php echo __('Keyword'); ?>', '<?php echo __('Value'); ?>'); return false;">
	...
	<p><a class="close-link" href="#" onclick="$('#<?php echo $css_id_prefix; ?>new-popup').toggle(); return false;"><?php echo __('Close'); ?></a></p>
  </form>
</div>
