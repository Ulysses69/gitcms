...
if ($driver == 'mysql')
{
    ...
    $PDO->exec("ALTER TABLE ".TABLE_PREFIX."page ADD robots VARCHAR(255) NULL default NULL , ADD redirect VARCHAR(255) NULL default NULL , ADD canonical VARCHAR(255) NULL default NULL");
}
