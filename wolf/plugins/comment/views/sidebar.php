...
<p class="button"><a href="<?php echo get_url('plugin/comment/moderation/'); ?>"><img src="<?php echo COMMENT_ROOT;?>/images/moderation.png" align="middle" alt="page icon" /> <?php echo __('Pending'); ?></a></p>
