 ...
 */
?>
<!-- <p class="button"><a href="<?php echo get_url('plugin/backup_restore/documentation'); ?>"><img src="<?php echo BACKUPRESTORE_ROOT;?>/images/documentation-32-ns.png" align="middle" alt="documentation icon" /> <?php echo __('Documentation'); ?></a></p> -->
<p class="button"><a href="<?php echo get_url('plugin/backup_restore/backup'); ?>"><img src="<?php echo BACKUPRESTORE_ROOT;?>/images/page.png" align="middle" alt="xml icon" /> <?php echo __('Create a backup'); ?></a></p>
...
<p>
<?php echo __('The Backup/Restore plugin allows you to create complete backups of the CMS core database.'); ?><br />
</p>
<p>
