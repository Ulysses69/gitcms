...
<!--
<p>
    <?php echo __('The Backup/Restore plugin allows you to create complete backups of the CMS database. It generates an XML file that contains all records for each of the CMS database tables, and optionally all uploaded files.'); ?>
</p>
-->
<h2><a href="<?php echo get_url('plugin/backup_restore/backup'); ?>"><?php echo __('Creating a backup'); ?></a></h2>
<!--
<p>
...
-->
<h2><a href="<?php echo get_url('plugin/backup_restore/restore'); ?>"><?php echo __('Restore a backup'); ?></a></h2>
<!--
<p>
...
<p>
    ...
    functionality provided by CMS <strong>are</strong> backed up.
</p>
-->