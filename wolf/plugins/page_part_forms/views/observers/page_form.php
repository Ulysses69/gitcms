...
<div id="<?php echo $replace_with_id; ?>" class="">
<?php
...
?>
  <div class="<?php echo $css_class_prefix; ?>row <?php echo strtolower($title); ?>">
...
switch($element[PagePartFormsController::PROPERTY_TYPE]) {
  ...
  case PagePartFormsController::TYPE_DATE:
	...
	echo '<img onclick="displayDatePicker(\''.$field_name_content.'\');" src="<?php echo FILES_ROOT;?>/images/icon_cal.gif" alt="'.__('Show Calendar').'" />';
	echo '</span>'.PHP_EOL;
	break; 
}
?>
