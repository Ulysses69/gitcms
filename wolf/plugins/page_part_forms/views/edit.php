...
<p class="buttons">
  <input class="button" id="site-save-page" name="commit" type="submit" accesskey="s" value="<?php echo __('Save'); ?>" />
  <input class="button" id="site-update-page"  name="continue" type="submit" accesskey="e" value="<?php echo __('Save and continue'); ?>" />
  <a href="<?php echo $plugin_url; ?>" id="site-cancel-page" class="button" title="Close without saving">Cancel</a>
</p>
</form>