...
<table class="fieldset" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		<td class="help">Should Maintenance Mode be On or Off?<br /><strong>Selecting "On" will take the site offline.</strong></td>
	</tr>
	<tr>
		<td class="label">Authorized Access:</td>
		<td class="field">
			<input type="radio" name="maintenanceAuthorizedAccess" <?php if($settings['maintenanceAuthorizedAccess'] == 'on') echo 'checked="checked" '; ?>value="on" /> On<br />
			<input type="radio" name="maintenanceAuthorizedAccess" <?php if($settings['maintenanceAuthorizedAccess'] == 'off') echo 'checked="checked" '; ?>value="off" />	Off
		</td>
		<td class="help">Should authorized users be allowed access?<br /><strong>Selecting "On" bypasses IP check.</strong></td>
	</tr>
	<tr>
		<td class="help" colspan="3">
			<h3>Mode</h3>
