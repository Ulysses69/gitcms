...
<?php foreach($tags as $tag): ?>
  <li id="snippet_<?php echo $tag->id; ?>" class="snippet node <?php echo odd_even(); ?>">
	<img align="middle" alt="snippet-icon" src="<?php echo URL_PUBLIC;?>wolf/plugins/tagger/images/tag.png" />
	...
	<?php endif; ?>
	<img class="handle" src="<?php echo URL_PUBLIC.ADMIN_DIR;?>images/drag.gif" alt="<?php echo __('Drag and Drop'); ?>" align="middle" />
	<div class="remove"><a href="<?php echo get_url('plugin/tagger/delete/'.$tag->id); ?>" onclick="return confirm('<?php echo __('Are you sure you wish to delete'); ?> <?php echo $tag->name; ?>?');"><img src="<?php echo URL_PUBLIC.ADMIN_DIR;?>/images/icon-remove.gif" alt="remove icon" /></a></div>
  </li>
<?php endforeach; ?>
</ul>
