<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = $_SERVER{'DOCUMENT_ROOT'}.'/public'; // absolute or relative from this script path, required.
	$mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
	$mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
	$mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^_thumbs$/i';
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,mp4,ogv,ogg,webm";
	...
	$mcImageManagerConfig['thumbnail.folder'] = "_thumbs"; // required, exclude this folder with file pattern '/^_thumb$/i' if you don't want it to show
	$mcImageManagerConfig['thumbnail.prefix'] = "_"; //
