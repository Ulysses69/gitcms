...
session_start();
$tinybrowser['sessioncheck'] = 'initiated'; //name of session variable to check
...
$tinybrowser['path']['image'] = '/public/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/public/videos/'; // Media files location
$tinybrowser['path']['file']  = '/public/documents/'; // Other files location
...
$tinybrowser['filetype']['media'] = '*.swf, *.dcr, *.mov, *.qt, *.mpg, *.mp3, *.mp4, *.mpeg, *.avi, *.wmv, *.wm, *.asf, *.asx, *.wmx, *.wvx, *.rm, *.ra, *.ram, *.ogv, *.webm'; // Media file types
$tinybrowser['filetype']['file']  = '*.*'; // Other file types

// Prohibited file extensions
$tinybrowser['prohibited'] = array('php','php3','php4','php5','phtml','asp','aspx','ascx','jsp','cfm','cfc','pl','bat','exe','dll','reg','cgi','sh','py','asa','asax','config','com','inc','ini','htaccess','inf','dat');
